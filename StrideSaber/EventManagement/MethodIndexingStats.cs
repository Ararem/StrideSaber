...
namespace StrideSaber.EventManagement
{
	...
	public struct MethodIndexingStats
	{
		...
		/// </summary>
		public uint AssemblyScanCount { get; set; }

		/// <summary>
		/// The number of <see cref="Type">Types</see> that were found and scanned
		/// </summary>
		public uint TypeScanCount { get; set; }
		...
		/// </summary>
		public uint MethodScanCount { get; set; }
		...
		/// </summary>
		public uint InvalidMethodCount { get; set; }
